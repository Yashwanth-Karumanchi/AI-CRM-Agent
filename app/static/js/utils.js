...
// ── Heroicon SVGs (inline, 20px stroke) ───────────────
const Icons = {
    ...
    users: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20H7m10 0v-2a4 4 0 00-4-4H7a4 4 0 00-4 4v2m14-10a4 4 0 11-8 0 4 4 0 018 0zM5 8a2 2 0 11-4 0 2 2 0 014 0zm14 6h.01M1 14h.01"/></svg>`,
